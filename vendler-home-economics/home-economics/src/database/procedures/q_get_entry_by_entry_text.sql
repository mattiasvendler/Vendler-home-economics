...
begin
  select a.id accountId,a.name,a.account_nr,aga.account_group_id groupId
  from vhe.entry e,vhe.account a,vhe.account_group_accounts aga
  where e.account_id=a.id and
